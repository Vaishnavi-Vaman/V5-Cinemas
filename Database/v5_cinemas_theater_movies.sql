...
CREATE TABLE `theater_movies` (
  ...
  UNIQUE KEY `theater_id` (`theater_id`,`movie_id`),
  KEY `movie_id` (`movie_id`),
  CONSTRAINT `theater_movies_ibfk_1` FOREIGN KEY (`theater_id`) REFERENCES `theaters` (`theater_id`),
  CONSTRAINT `theater_movies_ibfk_2` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`movie_id`)
...
-- Dump completed on 2025-09-01 14:42:51
